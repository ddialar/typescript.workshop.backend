...
describe('[API] - Posts endpoints', () => {
  describe(`[GET] ${POSTS_EXTENDED_PATH}`, () => {
    ...
    it('returns OK (200) and retrieve the persisted posts and the owned one by the user, marked like that', async () => {
    ...
    it('returns OK (200) and retrieve the persisted posts and the owned one by the user, marked as liked by itself', async () => {
    ...
    it('returns OK (200) and retrieve the persisted posts and the owned one by the user, commented by itself', async () => {
    ...
    it('returns OK (200) and retrieve the persisted posts and the another user one, liked by the selected user', async () => {
    ...
    it('returns OK (200) and retrieve the persisted posts and the another user one, commented by the selected user', async () => {
    ...
    it('returns INTERNAL_SERVER_ERROR (500) when the posts retrieving process throws an exception', async () => {
